...
void Lab5::Init()
{
    ...
    camera_fov = RADIANS(60);
    left = -5.f;
    right = 5.f;
    bottom = -3.f;
    top = 3.f;
    
    projectionMatrix = glm::perspective(camera_fov, window->props.aspectRatio, 0.01f, 200.0f);
...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(3.5, 0.5f, 2.5));
