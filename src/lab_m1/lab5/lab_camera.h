    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            forward = glm::normalize(glm::vec3(rotate_ox * glm::vec4(forward, 1)));
            up = glm::normalize(glm::vec3(rotate_ox * glm::vec4(up, 1)));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::mat4 rotate_oy = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0));
    
            forward = glm::normalize(glm::vec3(rotate_oy * glm::vec4(forward, 1)));
            right = glm::normalize(glm::vec3(rotate_oy * glm::vec4(right, 1)));
            up = glm::normalize(glm::vec3(rotate_oy * glm::vec4(up, 1)));
        }
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat4 rotate_oz = glm::rotate(glm::mat4(1.0f), angle, forward);

            right = glm::normalize(glm::vec3(rotate_oz * glm::vec4(right, 1)));
            up = glm::normalize(glm::vec3(rotate_oz * glm::vec4(up, 1)));
