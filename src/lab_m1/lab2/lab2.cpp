...
void Lab2::Init()
{
    ...
    {
        vector<VertexFormat> tetra_vertices
        {
            VertexFormat(glm::vec3(4, 4, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // todo(student): complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(4, 4, 1), glm::vec3(0, 1, 0.5f)),
            VertexFormat(glm::vec3(4, 5, 0), glm::vec3(0, 0.5f, 0.5f)),
            VertexFormat(glm::vec3(5, 4, 0)),
        };

        vector<unsigned int> tetra_indices =
        {
            0, 1, 2,    // indices for first triangle
        ...
        meshes["tetra"] = new Mesh("generated tetra 1");
        meshes["tetra"]->InitFromData(tetra_vertices, tetra_indices);

        // Actually create the mesh from the data
        // CreateMesh("tetra", tetra_vertices, tetra_indices);
    }
...

    {
        ...
        {
            VertexFormat(glm::vec3(2, 2, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // todo(student): complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(3, 2, 0), glm::vec3(0, 1, 0.5f)),
            VertexFormat(glm::vec3(3, 3, 0), glm::vec3(0, 0.5f, 0.5f)),
        ...
        meshes["square"] = new Mesh("generated square 1");
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(3, 3, 0), glm::vec3(0.25f));
